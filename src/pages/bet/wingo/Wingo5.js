            ...
            <div data-v-0bba67ea="" className="TimeLeft__C-PreSale-body">
              <div data-v-0bba67ea="">
                ...
                <p >
                  ...
                  ><font
                    face="Arial, Microsoft YaHei, \\5FAE软雅黑, \\5B8B体, Malgun Gothic, Meiryo, sans-serif"
                    >{t('green: if the result shows 1,3,7,9 you will get (98*2) 196;If the result shows 5, you will get (98*1.5) 147')} </font
                  >
                </p>
                <p >
                  <font
                  ...
                  ><font
                    face="Arial, Microsoft YaHei, \\5FAE软雅黑, \\5B8B体, Malgun Gothic, Meiryo, sans-serif"
                    >{t('red: if the result shows 2,4,6,8 you will get (98*2) 196;If the result shows 0, you will get (98*1.5) 147')}</font
                  >
                </p>
                <p >
                  <font
                  ...
                  ><font
                    face="Arial, Microsoft YaHei, \\5FAE软雅黑, \\5B8B体, Malgun Gothic, Meiryo, sans-serif"
                    >{t('violet:if the result shows 0 or 5, you will get (98*4.5) 441')}</font
                  >
                </p>
                <p >
                  <font
                    face="Arial, Microsoft YaHei, \\5FAE软雅黑, \\5B8B体, Malgun Gothic, Meiryo, sans-serif"
                    >4. {t('Select number:if the result is the same as the number you selected, you will get (98*9) 882')}</font
                  >
                </p>
                <p >
                  <font
                    face="Arial, Microsoft YaHei, \\5FAE软雅黑, \\5B8B体, Malgun Gothic, Meiryo, sans-serif"
                    >5. {t('Select big: if the result shows 5,6,7,8,9 you will get (98 * 2) 196')}</font
                  >
                </p>
                <p >
                  <font
        ...
        >
          <div data-v-7f36fe93="" className="Betting__Popup-1">
            <div data-v-7f36fe93="" className="Betting__Popup-head">
              <div data-v-7f36fe93="" className="Betting__Popup-head-title">{t('Win Go 1Min')}</div>
              <div data-v-7f36fe93="" className="Betting__Popup-head-selectName">
                <span data-v-7f36fe93="">{t('Select')}</span>
  ...
  lastBet.status === 2 ? (
    <div data-v-e44179e3="" data-v-5d71c3fd="" className="WinningTip__C" style={{ display: isVisible ? '' : 'none' }}>
      <div data-v-e44179e3="" className="WinningTip__C-body isL">
        ...
        <div data-v-e44179e3="" className="WinningTip__C-body-l1 isL">{t('Sorry')}</div>

        <div data-v-e44179e3="" className={`WinningTip__C-body-l2 type${lastBet.result}`}>{t('Lottery results')}:
          <div data-v-e44179e3="">
        ...
        <div data-v-e44179e3="" className="WinningTip__C-body-l3">
          <div data-v-e44179e3="" className="isLose">{t('Lose')}</div>
          <div data-v-e44179e3="" className="gameDetail">{t('Period')}: 1 min {lastBet.stage}</div>
        </div>

        <div data-v-e44179e3="" className="WinningTip__C-body-l4">
          <div data-v-e44179e3="" className="acitveBtn"></div> 3 {t('seconds auto close')}
        </div>
